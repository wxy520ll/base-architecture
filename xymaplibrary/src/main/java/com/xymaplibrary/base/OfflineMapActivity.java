...
public class OfflineMapActivity extends AppCompatActivity implements MKOfflineMapListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initToorBar("离线地图管理",mToolbar);
        mToolbar.setBackgroundColor(Color.parseColor("#3A71FF"));
        ...
        arrayList = mkOfflineMap.getOfflineCityList();
    ...
    public void onGetOfflineMapState(int i, int i1) {
        ...
        switch (i) {
            case MKOfflineMap.TYPE_DOWNLOAD_UPDATE://有时候接收下载的回调
                //离线地图下载更新事件类型
    ...
    public void initToorBar(String s,Toolbar toolBar) {
