 ...
 * 最新
 */
public class RecommandFragment extends BaseMvpFragment<LoginPresenter> {
    @Override
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser){
            ToastUtils.showShort("recommand");
        }
    }

    @Override
    public View inflaterView() {
        return View.inflate(getActivity(), R.layout.fragment_recommand, null);
