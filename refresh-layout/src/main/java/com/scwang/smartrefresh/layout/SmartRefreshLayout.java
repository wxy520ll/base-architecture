...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent/*, NestedScrollingChild*/ {
    ...
    public RefreshInternal mRefreshHeader;     //下拉头部视图
    public RefreshInternal mRefreshFooter;     //上拉底部视图
    public RefreshContent mRefreshContent;   //显示内容视图
    //</editor-fold>
...
/*    //加载失败/数据为空/连接超时
    ...
    protected int noNetworkImg;
    protected String noNetworkText;
    protected int timeOutImg;
    protected String timeOutText;*/
    ...
    public SmartRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     /*   errorImage = ta.getResourceId(R.styleable.SmartRefreshLayout_errorImg, R.mipmap.ic_launcher);
        errorText=ta.getString(R.styleable.SmartRefreshLayout_errorText);
        emptyImg = ta.getResourceId(R.styleable.SmartRefreshLayout_errorImg, R.mipmap.ic_launcher);
        emptyText=ta.getString(R.styleable.SmartRefreshLayout_errorText);
        noNetworkImg = ta.getResourceId(R.styleable.SmartRefreshLayout_errorImg, R.mipmap.ic_launcher);
        noNetworkText=ta.getString(R.styleable.SmartRefreshLayout_errorText);
        timeOutImg = ta.getResourceId(R.styleable.SmartRefreshLayout_errorImg, R.mipmap.ic_launcher);
        timeOutText=ta.getString(R.styleable.SmartRefreshLayout_errorText);*/
        ta.recycle();
